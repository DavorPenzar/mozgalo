...
\begin{document}
    ...
    \begin{frame}{Hiperparametri}
        \only<1>{%
            \lstinputlisting[style = lijepo, stepnumber = 0, basicstyle = {\footnotesize \ttfamily \color{alpha}}, language = Python, caption = {Primjer konstrukcije modela}, label = {lst:model}]{model.py}%
        }
        \only<2>{%
            \lstinputlisting[style = lijepo, stepnumber = 0, basicstyle = {\footnotesize \ttfamily \color{alpha}}, language = Python, caption = {Primjer treniranja modela}, label = {lst:fit}]{fit.py}%
        }
    \end{frame}
    ...
    \begin{frame}{Programska realizacija}
        \centering
        \Huge
        \href{run:jupyter.sh}{Implementacija}
    \end{frame}{}
